        ...
        <div className="grid lg:grid-cols-2 gap-12 items-center">
          ...
          >
            ...
            <div className="space-y-4 text-gray-600">
              <p>
                Currently working as a Backend Developer at <strong className="text-blue-600">Viskamnix Technology</strong>, 
            ...
            <div className="flex flex-wrap gap-3">
              {skills.map((skill, index) => (
                <motion.span
                  ...
                  className="px-4 py-2 bg-white rounded-lg shadow-md text-gray-700 font-medium border border-gray-200 hover:shadow-lg transition-shadow"
                >
                  {skill}
                </motion.span>
              ))}
