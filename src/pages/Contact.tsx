  ...
  return (
    ...
    >
      ...
      <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
        ...
        <div className="backdrop-blur-sm bg-white/20 dark:bg-gray-900/20 p-8 rounded-xl border border-white/20 dark:border-gray-700/20 shadow-lg">
          <p className="text-center text-gray-700 dark:text-gray-300 text-lg">
            Contact form coming soon! Feel free to reach out through other channels.
          </p>
        </div>
      </div>
